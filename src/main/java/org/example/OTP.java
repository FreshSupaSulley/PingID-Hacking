...
/**
 * This class contains static methods that are used to calculate the One-Time Password (OTP) using JCE to provide the
 * HMAC-SHA-1.
 *
 * @author Loren Hart
 * @version 1.0
...
public class OTP {
	 ...
	 * @param codeDigits       the number of digits in the OTP, not including the checksum, if any. Valid values are
	 *                         between 3 and 8 inclusive.
	 * @param addChecksum      a flag that indicates if a checksum digit should be appended to the OTP.
	 * @param truncationOffset the offset into the MAC result to begin truncation. If this value is out of the range of
	 *                         0 ... 15, then dynamic truncation will be used. Dynamic truncation is when the last 4
	 ...
	 *
	 * @param secret           the shared secret
	 * @param text             The data input. This is an alternative to the movingFactor in the other variant of this
	 *                         method.
	 * @param codeDigits       the number of digits in the OTP, not including the checksum, if any. Valid values are
	 *                         between 3 and 8 inclusive.
	 * @param addChecksum      a flag that indicates if a checksum digit should be appended to the OTP.
